...
<template>
  <div class="flex w-full flex-col gap-6 lg:h-full lg:flex-row">
    <UCard
      class="flex w-full flex-col overflow-hidden rounded-2xl border border-default shadow-md ring-0"
      :class="props.showAgenda ? 'lg:w-1/2' : 'lg:w-full'"
