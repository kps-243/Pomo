...
const formatted = computed(() => (props.dueDate ? formatDueDateShort(props.dueDate) : null))
</script>
...
<template>
  <button
    ...
    :class="
      formatted ? 'bg-primary/10 text-primary-800 dark:text-primary-300' : 'bg-elevated text-toned'
    "
    :aria-label="
      formatted ? `Échéance : ${formatted}. Cliquer pour modifier.` : 'Définir une échéance'
    "
  >
